...
trainer = pl.Trainer(max_epochs=5, fast_dev_run=False, default_root_dir=os.getcwd(), strategy="deepspeed_stage_3", accelerator="gpu", devices=1, log_every_n_steps=25, callbacks=[TimeEpochCallback()], logger=neptune_logger, precision=32, enable_progress_bar=False) #gpus=1
